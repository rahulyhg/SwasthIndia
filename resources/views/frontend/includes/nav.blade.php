        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuUser">
                    ...
                    <a href="{{ route('frontend.patient.list') }}" class="dropdown-item {{ active_class(Active::checkRoute('frontend.patient.list')) }}">Patient List</a>
                    @endif
                    <a href="{{ route('frontend.doctor.list') }}" class="dropdown-item {{ active_class(Active::checkRoute('frontend.doctor.list')) }}">Doctor List</a>
